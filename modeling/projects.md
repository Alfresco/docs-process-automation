...
1. Check that the user has the [`ACTIVITI_MODELER` role](../administrator/identity/index.md).
...
**Note**: A project cannot be [deployed](../administrator/deploy/index.md) until it has been released to at least version 1. 
...
Released projects are the only projects that can be deployed and the only ones that will be visible in the [Administrator Application](../administrator/index.md).
